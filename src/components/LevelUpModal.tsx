  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-amber-600 mb-1">Level Up!</h2>
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 text-white flex items-center justify-center text-2xl font-bold mx-auto my-4 shadow-lg">
          {newLevel.level}
        </div>
